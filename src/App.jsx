    ...
    <main className="font-poppins">
      <section className="bg-[#7B2CBF] text-white relative pb-24 md:pb-32">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <header className="flex justify-between items-center py-6">
            <div className="text-[#E1957D] text-2xl font-poppins font-bold">
              Complete Market
            </div>
            <button className="bg-[#E1957D] text-white font-po px-6 py-2.5 rounded-full text-sm font-medium flex items-center gap-2">
              <User className="w-4 h-4 font-poppins" /> Login
            </button>
          </header>
          ...
          <div className="flex flex-wrap md:flex-nowrap items-center gap-8">
            ...
            <div className="w-full md:w-1/2 text-center md:text-left space-y-6">
              <h1 className="text-4xl md:text-[56px] font-poppins font-semibold leading-tight">
              ...
              <div className="hidden sm:flex flex-col sm:flex-row gap-4 bg-white text-black  rounded-xl lg:rounded-full p-2 shadow-lg">
                <div className="flex-1 flex items-center gap-2 px-3">
                  ...
                  <input
                    ...
                    className="w-full font-poppins rounded-7xl text-sm outline-none placeholder-black"
                  />
                </div>
                <button className="bg-[#E1957D] text-white font-poppins px-6 py-3 lg:rounded-full text-sm font-medium flex items-center gap-2">
                  <MapPin className="w-4 h-4 font-poppins" /> Use current
                  location
                </button>
              </div>
              ...
              <div className="grid grid-cols-1 gap-4 sm:hidden">
                ...
                <div className="flex items-center gap-2 px-4 py-3 bg-white text-gray-900 rounded-lg shadow-lg border border-gray-200">
                  ...
                  <input
                    type="text"
                    placeholder="Where are you from Ibadan?"
                    className="w-full font-poppins text-sm outline-none placeholder-black"
                  />
                </div>
                {/* Button with consistent design */}
                <button className="bg-[#E1957D] text-white font-poppins px-6 py-3 rounded-lg text-sm font-medium flex items-center gap-2 shadow-lg">
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-bold text-center font-poppins mb-12">
      ...
      <section className="container mx-auto px-4 py-12 md:py-24">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            <h1 className="text-5xl md:text-6xl font-poppins font-bold tracking-tight text-gray-900">
            ...
            <button className="inline-flex items-center px-6 py-3 text-lg font-semibold font-poppins text-white bg-[#E1957D] rounded-full transition-colors">
              Start Ordering
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="flex flex-col items-center mb-10">
            ...
            <h2 className="text-4xl text-gray-900 font-poppins font-bold text-center">
            ...
            {proteins.map((row, rowIndex) => (
              ...
              >
                {row.map((protein) => (
                  <div
                    key={protein}
                    className="px-6 py-2 bg-[#E1957D] font-poppins rounded-full text-white font-medium shadow-sm hover:shadow-md transition-shadow"
                  >
                    {protein}
                  </div>
                ))}
      ...
      <section className="relative overflow-hidden bg-[#7B2CBF] font-poppins rounded-[32px] lg:rounded-[64px] mx-4 sm:mx-6 md:mx-8 lg:mx-12 my-6 max-w-[1100px] lg:mx-auto py-4 md:py-6 lg:py-8">
        <div className="container mx-auto px-4 sm:px-6 md:px-8 lg:px-24">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-4 lg:gap-6">
            ...
            <div className="flex-1 text-white text-center lg:text-left lg:pl-4">
              <h2 className="text-3xl sm:text-3xl md:text-4xl font-poppins lg:text-[5rem] font-bold leading-tight mb-3">
              ...
              <div className="flex justify-center lg:justify-start gap-8 mt-8 lg:mt-24">
                <button className="bg-[#E1957D] font-poppins  text-white px-3 py-2 sm:px-5 sm:py-3 rounded-[16px] flex items-center gap-2 transition-all">
                  <svg
                    className="w-4 h-4"
                    viewBox="0 0 24 24"
                    fill="currentColor"
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <div className="text-center">
              ...
              <button className="bg-[#E1957D] font-poppins text-white px-6 py-3 rounded-full transition-colors">
                Register here
              </button>
            </div>
      ...
      <footer className="bg-[#242127] font-poppins text-white py-16">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12">
            <div>
              <h3 className="text-3xl font-poppins font-bold mb-4 tracking-tight">
                Complete Market
              </h3>
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li>
                  <a
                    href="#"
                    className="hover:text-[#E1957D] font-poppins transition-colors"
                  >
                    About us
                  </a>
                </li>
